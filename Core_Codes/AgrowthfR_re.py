...
class Cosmosground(object):
    ...
    def sigma8_ratio(self, model, z, k = None):
        """
        Returns: the ratio from sigma8_model_ratio alone, taking the ratio over the sigma8 values obtained from the LCDM class (Instead of CAMB). Normalization checked from the plot.
